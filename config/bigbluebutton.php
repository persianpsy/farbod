...
return [
     ...
     */
    'BBB_SECURITY_SALT'   => 'WVbjTG3YeUTF8KURGbTdAbde1sLSCf10ffUzUtA6KY',
    'BBB_SERVER_BASE_URL' => 'https://meeting.persianpsychology.com/bigbluebutton',
    ...
    'create'              => [
         ...
         * var @mixed.
         **/
        'welcomeMessage'                     => 'همراه شما هستیم',
         ...
         * var @string
         */
        'logoutUrl'                          => 'https://persianpsychology.com',
         ...
         * var @string
         */
        'moderatorOnlyMessage'               => 'persian psychology',
         ...
         * var @bool
         */
        'webcamsOnlyForModerator'            => 'همراه شما هستیم، لطفا به توضیحات در صفحه اصلی دقت فرمایید',
         ...
         * var @string
         */
        'logo'                               => 'https://persianpsychology.com/assets/FinalLogo.84e7c853.png',
